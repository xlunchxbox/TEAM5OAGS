...
Work.create!(acquisition_price: 100, asking_price: 100, date_acquired: Time.now, date_sold: nil, title: 'Die Treppe', medium: "High quality print", description: "This art print displays sharp, vivid images with a high degree of color accuracy.", copy: "1/12", artist_id: 1)
Work.create!(acquisition_price: 3000, asking_price: 620, date_acquired: Time.now, date_sold: nil, title: 'Il Viale del Gardino', medium: "Watercolor", description: "This art print displays sharp, vivid images with a high degree of color accuracy.", copy: "1/12", artist_id: 1)
Work.create!(acquisition_price: 248, asking_price: 349, date_acquired: Time.now, date_sold: Time.now, title: 'Irises', medium: "High quality print", description: "This art print displays sharp, vivid images with a high degree of color accuracy.", copy: "1/12", artist_id: 1)
Work.create!(acquisition_price: 500, asking_price: 500, date_acquired: Time.now, date_sold: Time.now, title: 'Le Pont Japonais', medium: "Canvas", description: "This art print displays sharp, vivid images with a high degree of color accuracy.", copy: "1/12", artist_id: 1)
Work.create!(acquisition_price: 700, asking_price: 820, date_acquired: Time.now, date_sold: Time.now, title: 'Path Through the Corn', medium: "Watercolor", description: "This art print displays sharp, vivid images with a high degree of color accuracy.", copy: "1/12", artist_id: 1)
Work.create!(acquisition_price: 500, asking_price: 1099, date_acquired: Time.now, date_sold: nil, title: 'Venice Palazzo', medium: "Watercolor", description: "This art print displays sharp, vivid images with a high degree of color accuracy.", copy: "1/12", artist_id: 1)
Work.create!(acquisition_price: 400, asking_price: 660, date_acquired: Time.now, date_sold: Time.now, title: 'Water Lilies', medium: "High quality print", description: "This art print displays sharp, vivid images with a high degree of color accuracy.", copy: "1/12", artist_id: 1)
Work.create!(acquisition_price: 3000, asking_price: 4000, date_acquired: Time.now, date_sold: Time.now, title: 'Almond Branches in Bloom', medium: "High quality print", description: "This art print displays sharp, vivid images with a high degree of color accuracy.", copy: "1/12", artist_id: 1)
Work.create!(acquisition_price: 3000, asking_price: 7800, date_acquired: Time.now, date_sold: nil, title: 'Starry Night', medium: "High quality print", description: "This art print displays sharp, vivid images with a high degree of color accuracy.", copy: "1/12", artist_id: 1)
